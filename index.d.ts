...
type EagerModelLollipopLocationsMDAMB231Connection = {
  readonly items: (LollipopLocationsMDAMB231 | null)[];
  readonly nextToken?: string | null;
}

type LazyModelLollipopLocationsMDAMB231Connection = {
  readonly items: (LollipopLocationsMDAMB231 | null)[];
  readonly nextToken?: string | null;
}

export declare type ModelLollipopLocationsMDAMB231Connection = LazyLoading extends LazyLoadingDisabled ? EagerModelLollipopLocationsMDAMB231Connection : LazyModelLollipopLocationsMDAMB231Connection

export declare const ModelLollipopLocationsMDAMB231Connection: (new (init: ModelInit<ModelLollipopLocationsMDAMB231Connection>) => ModelLollipopLocationsMDAMB231Connection)
