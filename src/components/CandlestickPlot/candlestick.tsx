...
const geneList: string[] = [
  "ABRAXAS1", "APTX", "ATM", "ATR", "BARD1", "BLM", "BRCA1", "BRCA2", "BRIP1",
  "CDK12", "CDK5RAP2", "CEP152", "CEP63", "CHEK2", "DCLRE1C", "DNA2", "DONSON",
  "ERCC1", "ERCC2", "ERCC3", "ERCC4", "ERCC5", "ERCC6", "ERCC8", "FANCA", "FANCC",
  "FANCD2", "FANCE", "FANCF", "FANCG", "FANCI", "FANCL", "FANCM", "GTF2H5", "HLTF",
  "HROB", "LIG4", "LMNA", "MCM8", "MCM9", "MCPH1", "MLH1", "MRE11A", "MSH2",
  "MSH6", "MUTYH", "NBN", "NHEJ1", "NIN", "ORC1", "ORC4", "PALB2", "PCNT", "PMS2",
  "PNKP", "POLE", "POLH", "PRKDC", "RAD50", "RAD51", "RAD51C", "RAD51D", "RBBP8",
  "RECQL", "RECQL4", "REV3L", "RFWD3", "RIF1", "RNASEH2A", "RNF168", "RTEL1",
  "SAMHD1", "SETX", "SLX4", "SMARCAL1", "TDP1", "TONSL", "TP53BP1", "TRAIP",
  "TREX1", "UBE2T", "UVSSA", "WRN", "XPA", "XRCC3", "ZRANB3"
];
                ...
                <div className="radioRight overlfowAuto">
                  ...
                  <div className="filterBox">
                    ...
                    <div className="filterRow secondFilterRow">
                      ...
                      <div className= "filterColumn">
                        {this.state.renderConfigData.lollipopsMDAMB231.length > 0 && this.state.treatment == 'UNT'   ? <label className="filterBody"><input type="radio" className="rightSideButton" onClick={this.setCellLine("MDAMB231")} checked={this.state.radioCheckedCell.get("MDAMB231")}/>&nbsp;MDA-MB-231</label> : <label></label>}
                      </div>
                    </div>
