...
type EagerGeneLollipopGraphModel = {
  ...
  readonly lollipopLocationsMCF7?: ModelLollipopLocationsMCF7Connection | null;
  readonly lollipopLocationsMDAMB231?: ModelLollipopLocationsMDAMB231Connection | null;
...
export declare type ModelLollipopLocationsMDAMB231ConnectionModel = LazyLoading extends LazyLoadingDisabled ? EagerModelLollipopLocationsMDAMB231ConnectionModel : LazyModelLollipopLocationsMDAMB231ConnectionModel
...
const { Alias, Auth, Domain, Fish, Fly, GeneLollipopGraph, GeneLollipopGraphMCF7, HomoSapiens, LollipopLocations, LollipopLocationsMCF7, LollipopLocationsMDAMB231, ModelAliasConnection, ModelAuthConnection, ModelDomainConnection, ModelFishConnection, ModelFlyConnection, ModelGeneLollipopGraphConnection, ModelGeneLollipopGraphMCF7Connection, ModelHomoSapiensConnection, ModelLollipopLocationsConnection, ModelLollipopLocationsMCF7Connection, ModelLollipopLocationsMDAMB231Connection, ModelMouseConnection, ModelNematodeConnection, ModelPlantConnection, ModelRatConnection, ModelYeastConnection, Mouse, Nematode, Plant, Rat, Yeast } = initSchema(schema) as {
  ...
  ModelLollipopLocationsMDAMB231Connection: PersistentModelConstructor<ModelLollipopLocationsMDAMB231ConnectionModel>;
